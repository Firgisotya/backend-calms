...
module.exports = {
  ...
  remainding: async (req, res) => {
    try {
      let query;
      query =
        await sequelize.query(`SELECT equipment_name, evidance, DATEDIFF(exp_calibration, CURDATE()) AS sisa_hari FROM trans_kalibrasi WHERE exp_calibration
  ...
  remamaindingExp: async (req, res) => {
    try {
      let query;
      query =
        await sequelize.query(`SELECT equipment_name, evidance, DATEDIFF(CURDATE(), exp_calibration) AS lebih_hari FROM trans_kalibrasi WHERE exp_calibration
  ...
  count_temp: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        `SELECT * FROM trans_kalibrasi WHERE category = 6`
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_press: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE category = 7"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_mass: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE category = 8"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_ph: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE category = 5"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_conduct: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE category = 4"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_dimensi: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE category = 10"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_refracto: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE category = 3"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_enclosure: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE category = 12"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  count_thermohygro: async (req, res) => {
    try {
      let query;
      query = await sequelize.query(
        "SELECT * FROM trans_kalibrasi WHERE sub_category = 5"
      );
      res.status(200).json({
        status: 200,
        message: "Success",
  ...
  table_pending: async (req, res) => {
    try {
      let query;
      query =
        await sequelize.query(`SELECT a.id,a.id_trans,a.reg_or_recal,a.in_or_ex,
