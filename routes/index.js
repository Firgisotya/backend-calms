...
const { count_jenis_weekly, count_reg_weekly, count_jenis_monthly, count_jenis_yearly, count_reg_yearly, month_trans, year_trans, getTrans, cetak } = require('../controllers/report');
